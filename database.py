...
def Indexes():
    ...
    with driver.session() as session:
      ...
      for u in utility:
        ...
        query = "MATCH (u:utility WHERE u.name='{name}')  set u.update='{updated}' set u.price='{price}' set u.eps='{eps}' set u.pe_ratio='{pe_ratio}'  set u.beta='{beta}'  set u.sharpo='{sharpo}'".format(name=u['name'], 
                                                                                                                                                                                                             updated=updated
                                                                                                                                                                                                             price=str(price), 
                                                                                                                                                                                                             eps=str(eps), 
